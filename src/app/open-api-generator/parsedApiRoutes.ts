...
export type ApiRoute = {
  ...
  // Query params generated by ./parser/
  parsedQueryParams?: TypesParser.Schema;
  parsedPathParams?: TypesParser.ParsedPathParams;
...
export class ParsedApiRoutes {
  ...
  public parse(generatedApiRoute: any) {
    const route = generatedApiRoute.route;
    const querySchema =
      generatedApiRoute.querySchema as TypesParser.ParsedTypes;
    ...
    let shouldAllowRelaxedTypes = this.shouldAllowRelaxedTypes(
      route,
      allParams,
      this.sanitizeTypes(route.response.type),
    );

    if (!shouldAllowRelaxedTypes) {
      shouldAllowRelaxedTypes =
        (querySchema.queryParams &&
        querySchema.queryParams._requiresRelaxedTypeAnnotation
          ? querySchema.queryParams._requiresRelaxedTypeAnnotation
          : false) || (querySchema.pathParams ? querySchema.pathParams._requiresRelaxedTypeAnnotation : false);
    }
    ...
    const apiRoute: ApiRoute = {
      ...
      shouldAllowRelaxedTypes: shouldAllowRelaxedTypes,
      ...
      parsedQueryParams: querySchema.queryParams,
      parsedPathParams: querySchema.pathParams,
    };
