...
export class ParsedApiRoutes {
  ...
  public parse(generatedApiRoute: any) {
    ...
    const paramSchema =
      generatedApiRoute.paramSchema as TypesParser.ParsedTypes;
    ...
    if (!shouldAllowRelaxedTypes) {
      shouldAllowRelaxedTypes =
        ...
        paramSchema.queryParams._requiresRelaxedTypeAnnotation
          ? paramSchema.queryParams._requiresRelaxedTypeAnnotation
          : false) ||
        (paramSchema.pathParams
          ? paramSchema.pathParams._requiresRelaxedTypeAnnotation
          : false);
    }
    ...
    const apiRoute: ApiRoute = {
      ...
      parsedQueryParams: paramSchema.queryParams,
      parsedPathParams: paramSchema.pathParams,
    };
