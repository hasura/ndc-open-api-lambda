...
## Unreleased
- Bug fix: Replaced `*/` with `*''/` in API descriptions so that multi line comments do not end pre maturely resulting in a sytanx error ([#21](https://github.com/hasura/ndc-open-api-lambda/pull/21))
